        ...
        <Fade left>
          <div className={styles.m_left}>
            <p className={styles.m_header}>
              Learn the <span>Foundation</span> And Make Your{" "}
              <span>Future.</span>{" "}
            </p>
      ...
      <div className={styles.aboutcontainer}>
        ...
        <Fade left>
          <p className={styles.abouttfp}>
            The Foundation Program is a 30-Day Hybrid Bootcamp aimed at
            addressing the skill gap by helping students up-skill with a
            foundation program in programming and web development. The program
            aims to help the students build a foundational skill level to find
