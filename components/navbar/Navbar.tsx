    ...
    <div className={styles.navContainer}>
      ...
      <div className={styles.navLevelsContainer}>
        <Link href={lvl1Status ? "" : "/lvl1"}>
          <div className={styles.navLevels}>
            LEVEL 1 {lvl1Status && <LockIcon />}
          </div>
        </Link>
        <Link href={lvl2Status ? "" : "/lvl2"}>
          <div className={styles.navLevels}>
            LEVEL 2{lvl2Status && <LockIcon />}
          </div>
        </Link>
        <Link href={lvl3Status ? "" : "/lvl3"}>
          <div className={styles.navLevels}>
            LEVEL 3 {lvl3Status && <LockIcon />}
          </div>
        </Link>
        <Link href={lvl4Status ? "" : "/lvl4"}>
          <div className={styles.navLevels}>
            LEVEL 4{lvl4Status && <LockIcon />}
          </div>
        </Link>
      </div>
      <div className={styles.navSocialsContainer}>
        ...
        <a
          href="https://www.youtube.com/@mulearn"
          target="blank"
          className={styles.navSocials}
        >
